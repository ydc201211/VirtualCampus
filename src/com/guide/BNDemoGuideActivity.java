...
public class BNDemoGuideActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Fragment_Map.activityList.add(this);
		createHandler();
		...
		if (intent != null) {
			...
			if (bundle != null) {
				mBNRoutePlanNode = (BNRoutePlanNode) bundle
						.getSerializable(Fragment_Map.ROUTE_PLAN_NODE);
	...
	protected void onDestroy() {
		...
		Fragment_Map.activityList.remove(this);
		super.onDestroy();
	}
				...
				public void handleMessage(android.os.Message msg) {
					if (msg.what == MSG_SHOW) {
						...
						BNRouteGuideManager.getInstance()
								.resetEndNodeInNavi(
										new BNRoutePlanNode(116.21142,
												40.85087, "百度大厦11", null,
