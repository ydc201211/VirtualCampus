...
public class MarkEntity implements Serializable {
	...
	public int markId;  //标记ID
	public String markName;//标记名称
	public double mark_latitude;//标价纬度
	public double mark_longitude;
	public String mark_detail;
	public int mark_like;
	public int mark_parentId;
	public int mark_isOnMap;
